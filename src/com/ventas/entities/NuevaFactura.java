...
public class NuevaFactura {
    ...
    public NuevaFactura(Long id, Double gravado, Double impuesto, Double iva, Double total, Double totalMp, Producto producto, ArticuloCompra articulo, String cuitCliente, CompraClienteMercadoPago compraMercadoPago) {
        this.id = id;
