...
public class PDFBuilder {
    ...
    public File listadoFacturas(List<FacturaCompraReferenciaMercadoPago> facturas)
            throws FileNotFoundException, DocumentException, Exception {
        String fileNameFormatted = getFileNameListado();
        ...
        FileOutputStream ficheroPdf = new FileOutputStream("d:/ventasJO/data/pdf/" + fileNameFormatted + ".pdf");
        ...
        PdfPCell celdaEncabezado1 = new PdfPCell(new Paragraph("F.COBRO", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado2 = new PdfPCell(new Paragraph("CUIT", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado3 = new PdfPCell(new Paragraph("NOMBRE", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado4 = new PdfPCell(new Paragraph("IMPORTE", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado5 = new PdfPCell(new Paragraph("VENDEDOR", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado6 = new PdfPCell(new Paragraph("FACTURADO", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        PdfPCell celdaEncabezado7 = new PdfPCell(new Paragraph("Nro. FC", FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
        ...
        tablaDetalle.addCell(celdaEncabezado1).setBorder(PdfPCell.BOX);
        tablaDetalle.addCell(celdaEncabezado2).setBorder(PdfPCell.BOX);
        tablaDetalle.addCell(celdaEncabezado3).setBorder(PdfPCell.BOX);
        tablaDetalle.addCell(celdaEncabezado4).setBorder(PdfPCell.BOX);
        tablaDetalle.addCell(celdaEncabezado5).setBorder(PdfPCell.BOX);
        tablaDetalle.addCell(celdaEncabezado6).setBorder(PdfPCell.BOX);
        tablaDetalle.addCell(celdaEncabezado7).setBorder(PdfPCell.BOX);

        pdf.add(tablaDetalle);

        for (FacturaCompraReferenciaMercadoPago fcrmp : facturas) {
            String f_cobro = sdf.format(fcrmp.getCompraClienteMercadoPago().getFecha());
            String cuit = fcrmp.getCompraClienteMercadoPago().getCuit();
            String nombre = fcrmp.getCompraClienteMercadoPago().getNombre();
            String origen = fcrmp.getCompraClienteMercadoPago().getOrigen();
            IvaVentas iv = fcrmp.getIvaVentas();
            String f_factura = sdf.format(iv.getFecha());
            String importe = df.format(iv.getTotal());
            String nro_fc = iv.getNumeroFactura().toString();

            PdfPTable tablaContenido = new PdfPTable(7);
            tablaContenido.setWidthPercentage(100);
            tablaContenido.setWidths(anchos);

            PdfPCell contenido1 = new PdfPCell(new Paragraph(f_cobro, FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
            PdfPCell contenido2 = new PdfPCell(new Paragraph(cuit, FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
            PdfPCell contenido3 = new PdfPCell(new Paragraph(nombre, FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
            PdfPCell contenido4 = new PdfPCell(new Paragraph(importe, FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
            PdfPCell contenido5 = new PdfPCell(new Paragraph(origen, FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
            PdfPCell contenido6 = new PdfPCell(new Paragraph(f_factura, FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));
            PdfPCell contenido7 = new PdfPCell(new Paragraph(nro_fc, FontFactory.getFont("arial", 8, Font.BOLD, NEGRO)));

            contenido1.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
            contenido2.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
            contenido3.setHorizontalAlignment(PdfPCell.ALIGN_LEFT);
            contenido4.setHorizontalAlignment(PdfPCell.ALIGN_RIGHT);
            contenido5.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
            contenido6.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
            contenido7.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);

            tablaContenido.addCell(contenido1).setBorder(PdfPCell.BOX);
            tablaContenido.addCell(contenido2).setBorder(PdfPCell.BOX);
            tablaContenido.addCell(contenido3).setBorder(PdfPCell.BOX);
            tablaContenido.addCell(contenido4).setBorder(PdfPCell.BOX);
            tablaContenido.addCell(contenido5).setBorder(PdfPCell.BOX);
            tablaContenido.addCell(contenido6).setBorder(PdfPCell.BOX);
            tablaContenido.addCell(contenido7).setBorder(PdfPCell.BOX);

            pdf.add(tablaContenido);
        }

        pdf.close();
        return new File("d:/ventasJO/data/pdf/" + fileNameFormatted + ".pdf");
    }

    public File armarFacturaA(IvaVentas iv, List<RenglonFactura> rf) throws
            FileNotFoundException, DocumentException, Exception {
        ...
        FileOutputStream ficheroPdf = new FileOutputStream("c:/ventasJO/data/facturas_pdf/" + fileNameFormatted + ".pdf");
...
//        return new File(fileNameFormatted);
    ...
    public File armarFacturaB(IvaVentas iv, List<RenglonFactura> rf) throws FileNotFoundException, DocumentException, Exception {
        ...
        pdf.setMargins(10, 50, 30, 30);
        pdf.setMarginMirroringTopBottom(true);
        String rutaPdf = Constantes.ruta_pdf;

        String nr0 = dfn.format(iv.getNumeroFactura());

        FileOutputStream ficheroPdf = new FileOutputStream(rutaPdf + fileNameFormatted + ".pdf");
...
//        pieFc.addCell(pieFc6).setBorder(PdfPCell.NO_BORDER);
    ...
    private String getFileNameListado() {
        String tdf = "listado_FC_MP";
        return tdf;
    }
