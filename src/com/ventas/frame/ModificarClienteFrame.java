...
public class ModificarClienteFrame extends javax.swing.JFrame {
    ...
    private void guardarCliente() {
        if (validarCampos()) {
            ...
            cliente.setCategoriaDeIva(comboCategoria.getSelectedIndex() - 1);
    ...
    private void llenarCampos(Cliente cliente) {
        ...
        if (tipos != null && !tipos.isEmpty()) {
            for (TipoDoc t : tipos) {
                comboT.addItem(t.getDescripcion());
            }
...
//        comboCategoria.addItem("");
        ...
        model.addElement("");
        for (CategoriaArca ca : CategoriaArca.values()) {
            model.addElement(ca.getDetalle());
        }
...
//        model.addElement("4- Consumidor Final");
        ...
        if (cliente.getCategoriaDeIva() != null) {
            comboCategoria.setSelectedIndex(cliente.getCategoriaDeIva()+1);
        }//UtilCliente.getCategoria(cliente.getCategoriaDeIva());
//        if (cliente.getFormaDePago() != null) {
//            comboFormasPago.setSelectedIndex(cliente.getFormaDePago() - 1);
//        }
    }
