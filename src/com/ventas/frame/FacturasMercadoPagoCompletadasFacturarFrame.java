 ...
 * @author argia
 */
public class FacturasMercadoPagoCompletadasFacturarFrame extends javax.swing.JFrame {
     ...
     */
    public FacturasMercadoPagoCompletadasFacturarFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("COMPRAS MERCADO PAGO FACTURADAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturasMercadoPagoCompletadasFacturarFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturasMercadoPagoCompletadasFacturarFrame().setVisible(true);
            }
        });
    }
    ...
    private void cargarFacturas() {
        ...
        try {
            facturasComprasMP = new CompraClienteMercadoPagoService().getAllFacturasProcesadas();
        } catch (Exception ex) {
            Logger.getLogger(FacturasMercadoPagoCompletadasFacturarFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
