...
public class AbmRubroFrame extends javax.swing.JFrame {
    ...
    List<Rubro> listadoRubro = new ArrayList<>();
    ...
    private void modificarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarBtnActionPerformed
        int row = rubroTabla.getSelectedRow();
        if (row >= 0) {
            Rubro r = listadoRubro.get(row);
            ModificarRubroFrame mrf = new ModificarRubroFrame(r);
            mrf.setVisible(true);
            this.dispose();
        }
