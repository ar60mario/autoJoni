...
public class RecuperarDeAfipFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboSucursal.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "10" }));
...
//        }
        ...
        String tipo_cbte = "6";
        String pto_vta = Constantes.puntoVenta;
        if (t == 1) {
            if (l == 1) {
                tipo_cbte = "1";
            } else {
        ...
        if (a == 0) {
            ...
            iv.setNumeroSucursal(10);
            try {
                new IvaVentasService().saveIvaVentas(iv);
            } catch (Exception ex) {
                Logger.getLogger(RecuperarDeAfipFrame.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "ERROR 596");
                return;
            }
