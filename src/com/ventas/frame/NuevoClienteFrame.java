...
//        model.addElement("");
        ...
        DefaultComboBoxModel model3 = (DefaultComboBoxModel) comboTipo.getModel();
        
        model3.addElement("80 - CUIT");
        model3.addElement("86 - CUIL");
        model3.addElement("96 - DNI");
        model3.addElement("99 - C.F.");
        comboCategoria.setModel(model);
        comboFormasPago.setModel(model2);
        comboTipo.setModel(model3);
