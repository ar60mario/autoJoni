...
public class FacturarFrame extends javax.swing.JFrame {
    ...
    private String userdir = Constantes.userdir;
    private String excepcion = "";
    private String tipoComprob;
    private final String letraFacturaPapel = "B";
    private String sucursalFacturaPapel = Constantes.puntoVenta;
...
//            JOptionPane.showMessageDialog(this, "Hello");
    ...
    private void confirmar() {
        Configuracion config = null;
        String pto_vta = Constantes.puntoVenta; // Sucursal declarada WS
        try {
...
//                        e.printStackTrace();
                ...
                Integer suc = Integer.valueOf(pto_vta);
...
//                    }
    ...
    private void solicitarNuevoTicket() {
        ...
        Dispatch.call(wsaa, "Autenticar",
                new Variant("wsfe"),
                new Variant(userdir + certif),
                new Variant(userdir + llave),
                new Variant(wsdl));
