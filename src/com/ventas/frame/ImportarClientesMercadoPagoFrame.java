...
public class ImportarClientesMercadoPagoFrame extends javax.swing.JFrame {
    ...
    private SimpleDateFormat sdf_2 = new SimpleDateFormat("dd/MM/2yyy");
    ...
    private void initComponents() {
        ...
        tablaProductoImportado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nro.", "Fecha", "CUIT", "Nombre", "Monto", "Origen", "Operación"
            }
        ) {
        ...
        if (tablaProductoImportado.getColumnModel().getColumnCount() > 0) {
            ...
            tablaProductoImportado.getColumnModel().getColumn(2).setPreferredWidth(50);
            tablaProductoImportado.getColumnModel().getColumn(3).setPreferredWidth(280);
    ...
    private void llenarTablaProductoImportado() throws IOException, BiffException, Exception {
        ...
        if (compras != null && !compras.isEmpty()) {
            ...
            for (CompraClienteMercadoPago compra : compras) {
                ...
                nro += 1;
                modelo.addRow(fila);
                Date fe = sdf_2.parse(compra.getFecha().toString());
                
                System.out.println(sdf.format(fe));
            }
