 ...
 * @author argia
 */
public class ModificarFabricanteFrame extends javax.swing.JFrame {
     ...
     */
    public ModificarFabricanteFrame(Fabricante fabricante) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarFabricanteFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarFabricanteFrame(null).setVisible(true);
            }
        });
    }
    ...
    private void llenarFrame() {
        ...
        codigoTxt.setText(fabricante.getCodigo().toString());
        nombreTxt.setText(fabricante.getNombre());
    ...
    private void grabar() {
        if (validar()) {
            ...
            fabricante.setNombre(nombreTxt.getText());
            try {
                new FabricanteService().updateFabricante(fabricante);
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(this, "ERROR nro. 189");
                return;
            }
            JOptionPane.showMessageDialog(this, "GRABADO");
            volver();
        }
    }
