...
public class ImportarProductoParaActualizarPreciosFrame extends javax.swing.JFrame {
    ...
    public ImportarProductoParaActualizarPreciosFrame(File archivo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("EIMPORTAR EXCEL PARA ACTUALIZAR PRECIOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImportarProductoParaActualizarPreciosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImportarProductoParaActualizarPreciosFrame(null).setVisible(true);
            }
        });
    }
    ...
    private void llenarTablaProductoImportado() throws IOException, BiffException, Exception {
        listaProductos = LectorDeExcel.leerExcelParaActualizPrecios(archivoImportado);
    ...
    private void guardarProductos() {
        for (Producto p : produs) {
            try {
                ...
                Logger.getLogger(ImportarProductoParaActualizarPreciosFrame.class.getName()).log(Level.SEVERE, null, ex);
