...
public class AbmTitularesDeCuitFrame extends javax.swing.JFrame {

    private JPanel contentPanel;
    private List<TitularCuit> titulares;

    public AbmTitularesDeCuitFrame() {
        initComponents();
        limpiarCampos();
        cargarTitulares();
        llenarTabla();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbmTitularesDeCuitFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbmTitularesDeCuitFrame().setVisible(true);
            }
        });
    }
    ...
    private void limpiarCampos() {
        ...
        JFrame jFrame = AbmTitularesDeCuitFrame.this;
        jFrame.setLocationRelativeTo(null);
        jFrame.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        String str0 = "TITULARES DE CUIT"; // + " " + str1;
...
//                System.out.println("Cerrando ventana...");
    ...
    private void cargarTitulares() {
        ...
        try {
            ...
            Logger.getLogger(AbmTitularesDeCuitFrame.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "ERROR 196 - TITULARES");
        }
    }
    ...
    private void modificar() {
        int tit = tabla.getSelectedRow();
        TitularCuit tc1 = titulares.get(tit);
        ModificarTitularCuitFrame mtcf = new ModificarTitularCuitFrame(tc1);
